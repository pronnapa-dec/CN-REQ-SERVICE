...
namespace REPO.Models
{
    ...
    public partial class gcodeaModel
    {
    ...
    public partial class gcodebModel
    {
        public string code { get; set; }
        public string gname { get; set; }
        public string userid { get; set; }
    ...
    public partial class gcodecModel
    {
        public string code { get; set; }
        public string gname { get; set; }
        public string userid { get; set; }
    ...
    public partial class gcodedModel
    {
        public string code { get; set; }
        public string gname { get; set; }
        public string userid { get; set; }
    ...
    public partial class gcodeeModel
    {
        public string code { get; set; }
        public string gname { get; set; }
        public string userid { get; set; }
    ...
    public partial class MainCategoryModel
    {
    ...
    public partial class ProductDivisionModel
    {
