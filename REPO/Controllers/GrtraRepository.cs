...
namespace REPO.Controllers
{
    public class GrtraRepository
    {
        ...
        public List<GrtraModel> Grtra_Get(string item_code)
        {
            try
            {
                ...
                Connection();
                mscon.Open();
                List<GrtraModel> RequestModelList = SqlMapper.Query<GrtraModel>(mscon, "SP_ACC_GRTRA_GET", objParam, commandType: CommandType.StoredProcedure).ToList();
                mscon.Close();
