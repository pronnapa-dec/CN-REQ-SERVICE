...
{
    public class GoodpriceRepository
    {
        ...
        public List<GoodpriceModel> Goodprice_Get(string item_code)
        {
            try
            {
                ...
                Connection();
                mscon.Open();
                List<GoodpriceModel> RequestModelList = SqlMapper.Query<GoodpriceModel>(mscon, "SP_ACC_GOODPRICE_GET", objParam, commandType: CommandType.StoredProcedure).ToList();
                mscon.Close();
